...
public class ChangeSched {
    ...
    public static void main(String[] args) {
        ChangeSched gs = new ChangeSched();
    }
    ...
    public ChangeSched() {
        ...
        String url = "jdbc:mckoi:local://BedrockU.conf?create=false";        
    ...
    public void GetSchedule (String student) {
        try {
            ...
            System.out.println("retrieve schedule failed: " + e);
        }
    }
