 ...
 * Description:
 * This part of the project shows two buttons to let someone add questions to
 * the test or to take the test. Logins are required. 
 */
package proj4;
...
public class Main extends AbstractPageBean {
    ...
    /**
     *Called when the user clicks the "add questions to test" button
     */
    ...
    /**
     *Called when the user click the "administer test" button
     */
