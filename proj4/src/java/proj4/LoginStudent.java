 ...
 * Description:
 * This is a form for allowing a student to securely log into the system to take
 * a test.
 */
 ...
 * a test.
 */
public class LoginStudent extends AbstractPageBean {
    ...
    /**
     * <p>Construct a new Page bean instance.</p> Register the database driver.
     */
    public LoginStudent() {
        register();
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("LoginStudent Initialization Failure", e);
     ...
     *and if so proceeds to let the student take the test. Otherwise it goes back
     *to the main menu.
     */
